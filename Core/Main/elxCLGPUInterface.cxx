...
//--------------------------------------------------------
GPUOutputImageType::Pointer
CLGPUInterface::Threshold( CPUInputImageType::Pointer itkImage, double lowerThreshold, double upperThreshold,
                           double outsideValue )
{
...
//--------------------------------------------------------
BinGPUOutputImageType::Pointer
CLGPUInterface::BinaryThreshold( CPUInputImageType::Pointer itkImage, double lowerThreshold /* = 0.0 */,
                                 double upperThreshold /* = 255.0 */, uint8_t insideValue /* = 1u */,
...
CLGPUInterface::Median( CPUInputImageType::Pointer itkImage, const std::vector< unsigned int > &radius )
{
    ...
    typedef itk::GPUMedianImageFilter< GPUInputImageType, GPUOutputImageType > GPUFilterType;
    GPUFilterType::Pointer gpuFilter = GPUFilterType::New();
                                   ...
                                   unsigned int order, unsigned int direction )
{
    ...
    switch ( order )
    {
        ...
        case 2:
            ...
            break;
        default:
            o_string << "giving unsupported order type, giving order " << order << " should be in range [0, 2]"
                     << std::endl;
            SetLastError( o_string.str().c_str() );
            return NULL;
    }
...
//--------------------------------------------------------
GPUOutputImageType::Pointer
CLGPUInterface::DiscreteGaussian( CPUInputImageType::Pointer itkImage, double variance, unsigned int maximumKernelWidth,
...
CLGPUInterface::GradientAnisotropicDiffusion( CPUInputImageType::Pointer itkImage, double timeStep,
                                              ...
                                              unsigned int conductanceScalingUpdateInterval,
...
//--------------------------------------------------------
void
CLGPUInterface::SetLastError( const char *err )
{
