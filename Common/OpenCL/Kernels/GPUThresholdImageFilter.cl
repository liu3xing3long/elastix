...
OutPixelType Functor(InArgType lowerThreshold, InArgType upperThreshold,
                     OutArgType outsideValue, InPixelType currentValue)
{
...
#ifdef DIM_1
__kernel void ThresholdFilter(InArgType lowerThreshold, InArgType upperThreshold,
                              OutArgType outsideValue,
                              ...
                              int width)
{
  ...
  if(gix < width)
  {
    out[gix] = Functor(lowerThreshold, upperThreshold, outsideValue, in[gix]);
  }
}
#endif
                              ...
                              int width, int height)
{
  ...
  if(gix < width && giy < height)
  {
    ...
    out[gidx] = Functor(lowerThreshold, upperThreshold, outsideValue, in[gidx]);
  }
}
#endif
