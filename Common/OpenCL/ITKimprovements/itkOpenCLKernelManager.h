...
class ITKOpenCL_EXPORT OpenCLKernelManager:
        public LightObject
{
public:
    ...
    OpenCLEvent
    LaunchKernel( const std::size_t kernelId, const OpenCLSize &global_work_size,
    ...
    OpenCLEvent
    LaunchKernel( const std::size_t kernelId, const OpenCLEventList &event_list, const OpenCLSize &global_work_size,
                  const OpenCLSize &local_work_size = OpenCLSize::null,
                  const OpenCLSize &global_work_offset = OpenCLSize::null );
    ...
    OpenCLProgram
    BuildProgramFromSourceCode( const std::string &sourceCode, const std::string &prefixSourceCode = std::string(),
                                const std::string &postfixSourceCode = std::string(),
                                const std::string &extraBuildOptions = std::string() );
    
    OpenCLProgram
    BuildProgramFromSourceFile( const std::string &fileName, const std::string &prefixSourceCode = std::string(),
                                const std::string &postfixSourceCode = std::string(),
                                const std::string &extraBuildOptions = std::string() );
