...
GPUBinaryDilateImageFilter< TInputImage, TOutputImage, TKernel >::GPUBinaryDilateImageFilter()
{
    ...
    // create kernel
    m_BinaryDilateFilterGPUKernelHandle = this->m_GPUKernelManager->CreateKernel( program, "BinaryDilateFilter" );
}

template< typename TInputImage, typename TOutputImage, typename TKernel >
void
GPUBinaryDilateImageFilter< TInputImage, TOutputImage, TKernel >::GPUGenerateData()
{
    itkDebugMacro( << "GPUBinaryDilateImageFilter::GPUGenerateData() begin" );
    ...
    // launch kernel
    OpenCLEvent event = this->m_GPUKernelManager->LaunchKernel( kHd, OpenCLSize( globalSize ), OpenCLSize( localSize ) );
