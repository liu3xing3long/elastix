 ...
 *
 *=========================================================================*/
#ifndef itkCLGPUGradientNDAnisotropicDiffusionFunction_hxx
#define itkCLGPUGradientNDAnisotropicDiffusionFunction_hxx
...
namespace itk
{
template< typename TImage > double GPUGradientNDAnisotropicDiffusionFunction< TImage >::m_MIN_NORM = 1.0e-10;
...
GPUGradientNDAnisotropicDiffusionFunction< TImage >::GPUGradientNDAnisotropicDiffusionFunction()
{
    ...
    // create kernel
    this->m_ComputeUpdateGPUKernelHandle = this->m_GPUKernelManager->CreateKernel( program, "ComputeUpdate" );
}

template< typename TImage >
void
GPUGradientNDAnisotropicDiffusionFunction< TImage >::GPUComputeUpdate( const typename TImage::Pointer output,
                                                                       typename TImage::Pointer buffer, void *
...
//  this->m_GPUKernelManager->LaunchKernel( this->m_ComputeUpdateGPUKernelHandle, ImageDim, globalSize, localSize );
    this->m_GPUKernelManager->LaunchKernel( this->m_ComputeUpdateGPUKernelHandle, OpenCLSize( globalSize ), OpenCLSize( localSize ) );
}
