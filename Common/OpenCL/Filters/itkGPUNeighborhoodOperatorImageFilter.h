...
template< typename TInputImage, typename TOutputImage, typename TOperatorValueType = typename TOutputImage::PixelType, typename TParentImageFilter = NeighborhoodOperatorImageFilter< TInputImage, TOutputImage, TOperatorValueType > >
...
public:
    ...
    /** Neighborhood types */
    typedef Neighborhood< OperatorValueType, itkGetStaticConstMacro( ImageDimension ) > OutputNeighborhoodType;
...
private: ITK_DISALLOW_COPY_AND_ASSIGN( GPUNeighborhoodOperatorImageFilter );
