...
//     }
  ...
  this->m_UnaryFunctorImageFilterGPUKernelHandle = this->m_GPUKernelManager->CreateKernel(program, "BinaryThresholdFilter");
}
...
::GPUGenerateData()
{
  ...
  itkDebugMacro( << "GPUBinaryThresholdImageFilter::GPUGenerateData() finished" );
}
