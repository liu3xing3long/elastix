...
::GPUGenerateData()
{
  ...
  this->m_GPUKernelManager->template SetKernelArgWithImageAndBufferedRegion<GPUInputManagerType>
    (kHd, argidx, dynamic_cast< GPUInputManagerType* >(inPtr->GetGPUDataManager().GetPointer() /* GetDataManager() */));
  this->m_GPUKernelManager->template SetKernelArgWithImageAndBufferedRegion<GPUOutputManagerType>
    (kHd, argidx, dynamic_cast< GPUOutputManagerType* >(otPtr->GetGPUDataManager().GetPointer()  /* GetDataManager() */));
