...
int itkGPUBinaryDilateImageFilterTest3(int argc, char * argv[])
{
  if( argc < 7 )
    {
  ...
  typedef itk::GPUBinaryDilateImageFilter< IType, IType, SRType > FilterType;
...
int main(int argc, char * argv[])
{
  ...
  clock.Start();
  itkGPUBinaryDilateImageFilterTest3(argc, argv);
  clock.Stop();
